...
export default class Check extends BaseComponent {
    ...
    fetchCourseInfo = (value) => {
        ...
        dispatch({
            ...
            payload: {
                ...
                method: 'GET',
                url: 'http://192.168.43.191:8010/api/teacher/course/' + value
            }
    ...
    handleChange = (value) => {
        ...
        dispatch({
            ...
            payload: {
                valueField: 'dataList',
                method: 'GET',
                url: 'http://192.168.43.191:8010/api/teacher/checkIn/' + value
            }
        });
    };
    ...
    onCancel = (perCourseId, userId) => {
        ...
        dispatch({
            ...
            payload: {
                method: 'DELETE',
                url: `http://192.168.43.191:8010/api/file/file?perCourseId=${perCourseId}&userId=${userId}`
            },
        });
    };
